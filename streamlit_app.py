...
def predict(image):
    ...
    if classification == 0:
        ...
        st.write("Se detectó un tumor pituitario en la imagen.")
        st.write("Haga clic en el siguiente enlace para obtener más información:")
        st.markdown("<a href='https://www.cancer.gov/espanol/tipos/tumor-de-hipofisis' target='_blank'>Más información sobre Tumor Pituitario</a>", unsafe_allow_html=True)
